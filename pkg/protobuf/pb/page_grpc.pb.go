...
type PageServiceClient interface {
	...
	GetPages(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PagesResponse, error)
}
...
func (c *pageServiceClient) GetPages(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PagesResponse, error) {
	out := new(PagesResponse)
	err := c.cc.Invoke(ctx, "/pb.PageService/GetPages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PageServiceServer interface {
	...
	GetPages(context.Context, *emptypb.Empty) (*PagesResponse, error)
...
func (UnimplementedPageServiceServer) GetPages(context.Context, *emptypb.Empty) (*PagesResponse, error) {
...
func _PageService_GetPages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.PageService/GetPages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PageServiceServer).GetPages(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
