...
func (x *SongServerRequest) Reset() {
	*x = SongServerRequest{}
...
func (x *SongServerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SongServerRequest) ProtoMessage() {}

func (x *SongServerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_page_proto_msgTypes[0]
...
// Deprecated: Use SongServerRequest.ProtoReflect.Descriptor instead.
func (*SongServerRequest) Descriptor() ([]byte, []int) {
	return file_page_proto_rawDescGZIP(), []int{0}
}

func (x *SongServerRequest) GetSongName() string {
	if x != nil {
		return x.SongName
	}
	return ""
...
var file_page_proto_rawDesc = []byte{
	...
	,
...
var file_page_proto_goTypes = []interface{}{
	(*SongServerRequest)(nil), // 0: pb.SongServerRequest
}
var file_page_proto_depIdxs = []int32{
	0, // 0: pb.ChatService.SayHello:input_type -> pb.SongServerRequest
	0, // 1: pb.ChatService.SayHello:output_type -> pb.SongServerRequest
...
func file_page_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_page_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SongServerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
